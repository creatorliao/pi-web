...
做界面、流程、文案时**先用这两条拍板**，再写方案、再改代码。与专题方案冲突时以本表为准。

| 原则 | 一句话 | 做 | 不做 |
|------|--------|----|------|
| 好上手 | 跟大多数软件已经教会人的习惯走，降低适应成本 | 对齐 IDE / 常见桌面软件的开法、选法、关法（如欢迎选项目、窗口只显示文件夹名、系统字体） | 发明要说明书才懂的新套路 |
| 完整但不加戏 | 主路径闭环、该有的入口都在；多出来的一层不要 | 能选、能换、能失败重试、深链直达；一套 UI 复用 | 额外勾选/记住开关、假骨架、教练箭头、第二套并列列表、为「更完整」预加载用不上的信息 |

细则与正反例见 [20260820-01-最佳实践_产品价值观_好上手与不加戏](docs/02-Areas/20260820-01-最佳实践_产品价值观_好上手与不加戏.md)。起源拍板见 [R20260820-01 04-决策](docs/01-Projects/R20260820-01-启动首屏与工作空间入口/04-决策_设计规格_20260820_启动首屏与工作空间入口.md)。
...
产品判断见上方「产品价值观」与 [20260820-01-最佳实践_产品价值观_好上手与不加戏](docs/02-Areas/20260820-01-最佳实践_产品价值观_好上手与不加戏.md)。
