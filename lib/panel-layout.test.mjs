...
test("factory defaults keep the file rail and history rail the same width", () => {
  assert.equal(HISTORY_DEFAULT_WIDTH, SIDEBAR_DEFAULT_WIDTH);
  assert.equal(SIDEBAR_DEFAULT_WIDTH, 240);
});
