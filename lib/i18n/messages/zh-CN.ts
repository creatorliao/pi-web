...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.theme": "主题",
    "settings.layout": "工作区布局",
    "settings.layoutEditor": "编辑器（中间看文件）",
    "settings.layoutAssistant": "助手（中间对话）",
    "settings.layoutEditorHint": "目录在左，文件在中，对话在右。接近 Cursor 编辑器窗口。",
    "settings.layoutAssistantHint": "目录在左，对话在中，文件在右。适合在中间输入。",
    "settings.showHiddenFiles": "显示隐藏文件与构建目录",
    "settings.showHiddenFilesHint": "默认隐藏 .next、node_modules 等点文件和依赖目录。",
    "settings.needProject": "先选择项目后才能配置技能和插件",
    "settings.completionSound": "完成提示音",
    "settings.completionSoundHint": "智能体结束时播放短提示音。与底栏喇叭是同一开关。",
    "statusbar.label": "状态栏",
    "statusbar.gitBranch": "Git 分支 {branch}",
    "statusbar.conversationBranches": "对话分支",
    "statusbar.conversationBranchCount": "对话 {current}/{total}",
    "chat.effort": "思考",
    ...
    "chat.newChatShortcut": "新对话（{shortcut}）",
    "history.searchPlaceholder": "搜索对话…",
    "history.groupToday": "今天",
    "history.groupYesterday": "昨天",
    "history.groupLast7": "近 7 天",
    "history.groupOlder": "更早",
    "history.showMore": "More",
    "history.collapse": "收起",
    "history.noMatches": "无匹配",
    ...
    "workspace.dirMissing": "这个目录已经不在了，换一个或打开本机目录",
    "workspace.selectSession": "从历史打开或新建",
    "workspace.getStarted": "开始使用",
    "workspace.selectProject": "从侧边栏选择项目目录",
    "workspace.addModels": "打开左下角系统设置，在“模型”里添加模型",
    "workspace.stepProject": "从侧边栏选择项目目录",
    "workspace.stepModels": "打开左下角系统设置，在“模型”里添加模型",
    "workspace.pickerTitle": "选择工作空间",
    "workspace.switcherTitle": "切换工作空间",
    "workspace.pickerSubtitle": "打开一个目录后再开始对话",
    "workspace.productName": "Pi Web",
    "workspace.openFolder": "打开本机目录…",
    "workspace.useTodayDir": "使用今日目录",
    "workspace.loadingProjects": "正在加载最近项目…",
    "workspace.loadFailed": "无法加载最近项目",
    "workspace.retry": "重试",
    "workspace.noSessions": "尚无对话",
    "workspace.sessionCount": "{n} 个对话",
    "workspace.current": "当前",
    "workspace.addModel": "去设置添加模型",
    "workspace.filter": "搜索项目名或路径",
    "workspace.noMatches": "无匹配项目",
    "workspace.chooseAnother": "选择其他工作空间",
    "workspace.closeSwitcher": "关闭",
    "workspace.star": "星标",
    "workspace.unstar": "取消星标",
    "workspace.hide": "从列表隐藏",
    "workspace.hiddenToast": "已从列表隐藏",
    "workspace.resetHidden": "恢复隐藏的项目",
    "workspace.resetHiddenToast": "已恢复 {n} 个项目",
    "workspace.switchHint": "切换",
    "files.hidePanel": "隐藏文件面板",
    "files.showPanel": "显示文件面板",
    "files.hideAgentPanel": "隐藏对话栏",
    "files.showAgentPanel": "显示对话栏",
    "files.noneOpen": "没有打开的文件",
    "files.docOnDisk": "磁盘文件",
    "files.docGenerated": "会话生成",
    "files.docOriginal": "原文档",
    "files.docPreview": "预览",
    "files.docDiff": "对比",
    "files.historyTab": "完整历史.md",
    "files.systemTab": "系统提示词.md",
    "files.historyLoadFailed": "无法加载完整历史：{error}",
    "files.systemLoadFailed": "无法加载系统提示词：{error}",
    ...
    "chat.hideHistory": "收起对话列表",
    "workspace.emptyEditor": "在左侧打开一个文件，中间用来审阅。",
    "workspace.openAFile": "打开文件后会出现在这里",
    ...
    "chat.messagePlaceholder": "规划、实现…输入 / 调用技能，输入 @ 引用上下文",
    "chat.steer": "引导",
    "chat.followUp": "后续消息",
    "chat.send": "发送",
    "chat.voiceUnavailable": "语音输入尚未接线",
    "chat.reviewChanges": "Review",
    "chat.undoAll": "Undo All",
    "chat.reviewUnavailable": "仅界面：仓库还没有多文件 diff 审阅流程",
    "chat.undoUnavailable": "仅界面：仓库还没有撤销本轮写文件的接口",
    "chat.filesTouched": "{count} 个文件",
    "chat.composerResize": "拖动以调整输入框高度",
    "chat.contextUsage": "上下文已用 {percent} / {window}",
    "chat.contextUsageTitle": "上下文占用",
    "chat.contextUsedOf": "{used} / {window} tokens",
    "chat.contextUsageUnknown": "未知",
    "chat.removeChip": "移除 {label}",
