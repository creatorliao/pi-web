...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.layout": "Workspace layout",
    "settings.layoutEditor": "Editor (files in the center)",
    "settings.layoutAssistant": "Assistant (chat in the center)",
    "settings.layoutEditorHint": "Files on the left, documents in the center, chat on the right — like the Cursor editor window.",
    "settings.layoutAssistantHint": "Files on the left, chat in the center, documents on the right — better if you type in the middle.",
    "settings.showHiddenFiles": "Show hidden files and build folders",
    "settings.showHiddenFilesHint": "Hidden by default: .next, node_modules, and other dotfiles or dependency folders.",
    "settings.needProject": "Select a project first to configure skills and plugins",
    "settings.completionSound": "Completion sound",
    "settings.completionSoundHint": "Play a short tone when the agent finishes. Same switch as the status bar speaker.",
    "statusbar.label": "Status bar",
    "statusbar.gitBranch": "Git branch {branch}",
    "statusbar.conversationBranches": "Conversation branches",
    "statusbar.conversationBranchCount": "Chat {current}/{total}",
    "chat.effort": "Effort",
    "chat.modelSection": "Model",
    "theme.lightName": "Light",
    "theme.darkName": "Dark",
    "theme.autoName": "System",
    "chat.sessionMenu": "Session",
    "chat.sessionActions": "Session actions",
    "chat.newChatShortcut": "New chat ({shortcut})",
    "history.searchPlaceholder": "Search chats…",
    "history.groupToday": "Today",
    "history.groupYesterday": "Yesterday",
    "history.groupLast7": "Previous 7 days",
    "history.groupOlder": "Older",
    "history.showMore": "More",
    "history.collapse": "Show less",
    "history.noMatches": "No matches",
    "chat.newChatShortcutHint": "Ctrl+Alt+N",
    ...
    "workspace.dirMissing": "That folder is gone. Pick another or open a local folder.",
    "workspace.selectSession": "Open a chat from history or start a new one",
    "workspace.getStarted": "Get Started",
    "workspace.selectProject": "Select a project directory from the sidebar",
    "workspace.addModels": "Open System settings at the bottom left and add models",
    "workspace.stepProject": "Select a project directory from the sidebar",
    "workspace.stepModels": "Open System settings at the bottom left and add models",
    "workspace.pickerTitle": "Choose a workspace",
    "workspace.switcherTitle": "Switch workspace",
    "workspace.pickerSubtitle": "Open a folder to start chatting",
    "workspace.productName": "Pi Web",
    "workspace.openFolder": "Open local folder…",
    "workspace.useTodayDir": "Use today's folder",
    "workspace.loadingProjects": "Loading recent projects…",
    "workspace.loadFailed": "Couldn't load recent projects",
    "workspace.retry": "Retry",
    "workspace.noSessions": "No chats yet",
    "workspace.sessionCount": "{n} chats",
    "workspace.current": "Current",
    "workspace.addModel": "Add a model in Settings",
    "workspace.filter": "Search name or path",
    "workspace.noMatches": "No matching projects",
    "workspace.chooseAnother": "Choose another workspace",
    "workspace.closeSwitcher": "Close",
    "workspace.star": "Star",
    "workspace.unstar": "Unstar",
    "workspace.hide": "Hide from list",
    "workspace.hiddenToast": "Hidden from the list",
    "workspace.resetHidden": "Restore hidden projects",
    "workspace.resetHiddenToast": "Restored {n} projects",
    "workspace.switchHint": "Switch",
    "files.hidePanel": "Hide file panel",
    "files.showPanel": "Show file panel",
    "files.hideAgentPanel": "Hide chat panel",
    "files.showAgentPanel": "Show chat panel",
    "files.noneOpen": "No file open",
    "files.docOnDisk": "On disk",
    "files.docGenerated": "Generated",
    "files.docOriginal": "Original",
    "files.docPreview": "Preview",
    "files.docDiff": "Diff",
    "files.historyTab": "full-history.md",
    "files.systemTab": "system-prompt.md",
    "files.historyLoadFailed": "Could not load full history: {error}",
    "files.systemLoadFailed": "Could not load system prompt: {error}",
    ...
    "chat.hideHistory": "Hide chat list",
    "workspace.emptyEditor": "Open a file on the left to review it here.",
    "workspace.openAFile": "Opened files will appear here",
    ...
    "chat.messagePlaceholder": "Plan, build… / for skills, @ for context",
    "chat.steer": "Steer",
    "chat.followUp": "Follow-up",
    "chat.send": "Send",
    "chat.voiceUnavailable": "Voice input is not wired yet",
    "chat.reviewChanges": "Review",
    "chat.undoAll": "Undo All",
    "chat.reviewUnavailable": "Review is visual only — there is no apply/reject diff flow yet",
    "chat.undoUnavailable": "Undo All is visual only — there is no revert-written-files API yet",
    "chat.filesTouched": "{count} Files",
    "chat.composerResize": "Drag to resize the input",
    "chat.contextUsage": "Context {percent} of {window}",
    "chat.contextUsageTitle": "Context used",
    "chat.contextUsedOf": "{used} / {window} tokens",
    "chat.contextUsageUnknown": "Unknown",
    "chat.removeChip": "Remove {label}",
